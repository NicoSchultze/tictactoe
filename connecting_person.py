...
game = TicTacToe()
print("Willkommen zum TicTacToe Spiel! Du bist der zweite Spieler, bitte lasse die die IP-Adresse des Hosts mitteilen.\n")
adress = input("Bitte hier die Adresse eingeben:\n")
port = int(input("Außerdem bitte die Portnummer eingeben, welche von dem Host gewählt wurde:\n"))
game.connecting(adress, port)